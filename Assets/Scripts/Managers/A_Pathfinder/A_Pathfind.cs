...
public class A_Pathfind : MonoBehaviour
{
    ...
    public void StartFindPath(Vector3 startPos, Vector3 targetPos, A_Pathfind.SurfaceType[] surfacePenalties)
    {
        StartCoroutine(FindPath(startPos, targetPos, surfacePenalties));
    }
    ...
    IEnumerator FindPath(Vector3 startPos, Vector3 targetPos, A_Pathfind.SurfaceType[] surfacePenalties)
    {
