...
public class Pathfind_Grid : MonoBehaviour
{
    ...
    public static void UpdateGrid(Vector3 pos, int xToCheck, int yToCheck)
    {
        OnUpdateGrid?.Invoke(pos, xToCheck, yToCheck);
    }

    private void CheckPosition(Vector3 posToCheck, int xDirectionCheck, int yDirectionCheck)
    {
